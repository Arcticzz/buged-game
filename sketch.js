...
function draw() {
  ...
  strokeWeight(2);
  stroke(255);
  line(roof.position.x - 100,roof.position.y,ball.position.x,ball.position.y);
  line(roof.position.x - 50,roof.position.y,ball2.position.x,ball2.position.y);
  line(roof.position.x,roof.position.y,ball3.position.x,ball3.position.y);
  line(roof.position.x +50,roof.position.y,ball4.position.x,ball4.position.y);
  line(roof.position.x + 100,roof.position.y,ball5.position.x,ball5.position.y);
  pop();
